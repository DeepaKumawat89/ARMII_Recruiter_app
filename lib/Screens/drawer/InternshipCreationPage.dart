            ...
            child: Column(
              ...
              children: [
                _buildTextField(
                  ...
                  onChanged: internshipProvider.setLocation,
                ...
                _buildTextField(
                  ...
                  onChanged: internshipProvider.setRole,
                ...
                _buildTextField(
                  ...
                  onChanged: internshipProvider.setEducationLevel,
                    ...
                    children: [
                      Expanded(
                        child: RadioListTile(
                          ...
                          value: true,
                          groupValue: internshipProvider.isPaid,
                          activeColor: primaryColor,
                          onChanged: (value) => internshipProvider.setIsPaid(value as bool),
                        ),
                      ),
                      Expanded(
                        child: RadioListTile(
                    ...
                    children: [
                      Expanded(
                        child: _buildTextField(
                          ...
                          onChanged: internshipProvider.setPayFrom,
                          validator: (value) => internshipProvider.isPaid && (value?.isEmpty ?? true)
                      ...
                      Expanded(
                        child: _buildTextField(
                          ...
                          onChanged: internshipProvider.setPayTo,
                          validator: (value) => internshipProvider.isPaid && (value?.isEmpty ?? true)
                ...
                TextFormField(
                  ...
                  maxLines: 2,
                  onChanged: internshipProvider.setRequirements,
                ...
                TextFormField(
                  ...
                  maxLines: 4,
                  onChanged: internshipProvider.setExtraSkills,
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            final validationError = internshipProvider.validateFields();
                            ...
                            final success = await internshipProvider.saveInternship();
                            if (success) {
                              Fluttertoast.showToast(
                              ...
                              // Clear all fields
                              internshipProvider.clearFields();
                              ...
                              Fluttertoast.showToast(
                                msg: "Failed to post internship. Please try again.",
                                backgroundColor: Colors.red,
                                textColor: Colors.white,
                              );
                            }
